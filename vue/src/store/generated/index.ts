...
import HackatomOpctChainHackatomopctchainBadge from './hackatom-opct-chain/hackatomopctchain.badge'
import HackatomOpctChainHackatomopctchainChallenge from './hackatom-opct-chain/hackatomopctchain.challenge'
import HackatomOpctChainHackatomopctchainExercise from './hackatom-opct-chain/hackatomopctchain.exercise'
import HackatomOpctChainHackatomopctchainHackatomopctchain from './hackatom-opct-chain/hackatomopctchain.hackatomopctchain'
...
export default { 
  ...
  HackatomOpctChainHackatomopctchainBadge: load(HackatomOpctChainHackatomopctchainBadge, 'hackatomopctchain.badge'),
  HackatomOpctChainHackatomopctchainChallenge: load(HackatomOpctChainHackatomopctchainChallenge, 'hackatomopctchain.challenge'),
  HackatomOpctChainHackatomopctchainExercise: load(HackatomOpctChainHackatomopctchainExercise, 'hackatomopctchain.exercise'),
  HackatomOpctChainHackatomopctchainHackatomopctchain: load(HackatomOpctChainHackatomopctchainHackatomopctchain, 'hackatomopctchain.hackatomopctchain'),
