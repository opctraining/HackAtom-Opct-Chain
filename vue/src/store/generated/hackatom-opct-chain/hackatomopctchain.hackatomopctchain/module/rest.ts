 ...
 */
export interface HackatomopctchainQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: HackatomopctchainParams;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/hackatom-opct-chain/hackatomopctchain/exercises
   */
  queryExercises = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<HackatomopctchainQueryExercisesResponse, RpcStatus>({
      path: `/hackatom-opct-chain/hackatomopctchain/exercises`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/hackatom-opct-chain/hackatomopctchain/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<HackatomopctchainQueryParamsResponse, RpcStatus>({
      path: `/hackatom-opct-chain/hackatomopctchain/params`,
      method: "GET",
      format: "json",
      ...params,
    });
