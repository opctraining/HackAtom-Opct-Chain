...
type Challenge struct {
	...
	RewardId uint64 `protobuf:"varint,6,opt,name=rewardId,proto3" json:"rewardId,omitempty"`
}
...
func (m *Challenge) GetRewardId() uint64 {
	if m != nil {
		return m.RewardId
	}
	return 0
...
var fileDescriptor_eaa1bbf0e24f55c8 = []byte{
	...
	0x50, 0xa2, 0x87, 0x21, 0xa2, 0x34, 0x99, 0x91, 0x8b, 0xd3, 0x19, 0xa6, 0x51, 0x88, 0x8f, 0x8b,
	...
	,
}
...
func (m *Challenge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.RewardId != 0 {
		i = encodeVarintChallenge(dAtA, i, uint64(m.RewardId))
		i--
		dAtA[i] = 0x30
	}
	if len(m.Uri) > 0 {
...
func (m *Challenge) Size() (n int) {
	...
	if m.RewardId != 0 {
		n += 1 + sovChallenge(uint64(m.RewardId))
	}
	return n
}
